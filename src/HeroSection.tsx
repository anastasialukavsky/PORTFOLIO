  ...
  return (
    <>
      <section className='hero-section  h-[100dvh] relative z-[100]  flex flex-col justify-center items-center md:-translate-y-[30%] md:pt-96 portrait:w-[100svw] portrait:h-[100vh] landscape:xshort:w-[100svw] landscape:xshort:h-[100svh]'>
        <p className='hello-article self-end xs:pr-4 pr-[5%] font-mono   opacity-0 portrait:fixed portrait:top-[26%] text-[.9rem] md:text-[1.2vw]'>
          hello, i am
        </p>
        <h1
          id='text'
          className='anim-typewriter font-dida text-[6.7vw] z-[150] relative leading-none text-center portrait:text-[13.5vw]  portrait:self-center portrait:top-[29%] xshort:whitespace-nowrap portrait:fixed md:whitespace-nowrap'
        >
