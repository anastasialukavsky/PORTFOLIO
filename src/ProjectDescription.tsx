...
export default function ProjectDescription({
  ...
  return (
    <article ref={descRef} className='stack-content w-full h-fit lg:text-[.8rem] xl:text-[.9rem] 4xl:text-[1rem] text-[.6rem] 6xl:text-[1.1rem] leading-tight 2xl:leading-normal '>
      {toggleDesc ? (
        <>
          {shortDescription}
          <span
