  ...
  return (
    ...
    >
      <div className='front-end-section  md:text-[1.3vw] 4xl:text-[1rem]   flex w-[100vw]'>
        <div className='flex flex-col min-w-[50vw] portrait:basis-0 landscape:basis-1/2 pt-20 lg:pt-96  ml-[37px] portrait:ml-[25px] portrait:w-[95vw] relative z-[190] portrait:z-50'>
