...
const ProjectStack = React.forwardRef(
  ({ frontEnd, backEnd }: ProjectStackProps, ref) => {
    ...
    return (
      ...
      >
        <section className='h-full w-full p-2 3xl:py-0 4xl:py-10 lg:p-2 6xl:py-16 xl:p-5 xshort:p-1 portrait:max-h-full portrait:h-full portrait:p-0 portrait:px-2 short:pt-1'>
