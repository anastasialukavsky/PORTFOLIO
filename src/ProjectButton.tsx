  ...
  return (
    <div className='cursor-pointer flex  w-fit self-end h-fit items-center align-baseline pb-2 xl:pb-4 4xl:pb-10 5xl:pr-[8%] 6xl:pb-0 6xl:pr-[9%] portrait:pt-3 portrait:pb-5'>
      ...
      >
        ...
        <span
          className={` 
   border border-[#121212]  px-2 4xl:px-3 relative  -translate-x-1 -translate-y-1  4xl:py-2 5xl:text-[.9rem]  flex py-1 z-20 bg-white gap-2 lg:text-[.7rem] text-[.6rem] 2xl:text-[.8rem] xl:text-[.8rem] font-mono portrait:text-[.9rem] portrait:md:text-[1.1rem]`}
        >
